...
export const VideoContainer = () => {
  return (
    <div className="flex flex-col h-[95%] bg-white -translate-y-3 rounded-xl shadow-lg overflow-hidden">
      ...
      <div className="flex-1 bg-gray-100 p-2 flex items-center justify-center">
        <div className="w-full h-[95%] bg-black rounded-lg flex align-up items-center justify-center text-white">
